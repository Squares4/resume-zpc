  ...
  sectionDataRight: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          content: [
            `<strong>项目介绍</strong>
            云印蜂是一款为学生服务的云打印平台，涵盖小程序、APP和H5网页，并有配套的商家管理端。顾客将文件传输至平台，打印店收到文件自动打印，顾客到店立取，减少顾客排队等待时间。`,
            `<i></i>使用<em>Typescript</em>组织代码，使用<em>Taro</em>进行H5页面开发并适配多端。管理端使用<em>Ant Design Pro</em>进行搭建。`,
            `<i></i>使用Ant Design Pro能够快速搭建中后台服务，实现了<em>权限管理</em>、<em>mock数据</em>等推动产品、后台交付及方便项目迭代、维护的功能。`
          ]
        },
        {
          name: '每日情话',
          ...
          content: [
            ...
            `<i></i>利用<em>Canvas</em>实现了小程序上的基本图形绘制以及图像处理，自行封装了绘制工具函数，涵盖对小程序Canvas的基本操作和错误处理，能够绘制简单Canvas图像并生成海报。`,
          ]
        }
      ]
    }
